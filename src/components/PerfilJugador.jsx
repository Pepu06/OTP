...
const PerfilJugador = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://otpbackend1-31q78xpq6-pepu06s-projects.vercel.app/api/jugador/${jugadorId}`)
      .then((response) => {
    ...
    fetch(`https://otpbackend1-31q78xpq6-pepu06s-projects.vercel.app/api/historico/${jugadorId}`)
      .then((response) => {
        if (!response.ok)
