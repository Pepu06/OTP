...
const TablaPlayoff = () => {
    return (
        <div
            ...
            style={{ backgroundImage: `url(${tabla})`, backgroundSize: '67.23%', backgroundRepeat: 'no-repeat' }}
        >
            <div className="grid grid-cols-4 gap-2">
                ...
                <div className="space-y-[85px] mt-6">
                    {Array(4).fill("").map((_, index) => (
                        <div key={index} className="bg-plightgreen text-white p-2 rounded-lg text-center text-sm">
                            Nombre del equipo
                        </div>
                    ))}
                </div>
                <div className="space-y-[205px] mt-[85px]">
                    {Array(2).fill("").map((_, index) => (
                        <div key={index} className="bg-plightblue text-white p-2 rounded-lg text-center text-sm">
                            Nombre del equipo
                        </div>
                    ))}
                </div>
